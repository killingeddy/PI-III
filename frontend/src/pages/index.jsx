  ...
  return (
    <div className="scrollbar-hide relative containe h-screen bg-dblue overflow-hidden">
      ...
      <div className="container mx-auto h-screen flex relative overflow-hidden">
        <div className="absolute top-1/3 left-28 justify-center text-center">
          ...
          <button className="bg-dorange text-white font-body-bold uppercase text-xl px-8 py-2 rounded-full mt-8 cursor-pointer z-50">Explorar</button>
        </div>
